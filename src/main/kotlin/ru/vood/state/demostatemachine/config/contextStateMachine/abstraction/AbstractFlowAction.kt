...
abstract class AbstractFlowAction< CONTEXTDATA: ContextData<FlowStatesContext, FlowEventContext>>(from: FlowStatesContext) : AbstractAction<FlowStatesContext, FlowEventContext, CONTEXTDATA>(from) {
